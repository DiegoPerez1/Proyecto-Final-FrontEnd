        ...
        <div id="container" className={modalIsOpen ? 'blur' : ''}>
            ...
            <div id="contenedorGeneros">
                ...
                <div className="generos">
                    <button
                        className={`genero-btn ${generoSeleccionado === "Rock" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Country" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Soul" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Jazz" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Blues" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Hip-Hop" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Pop" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Reggae" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Folk" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "R&B" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Clasico" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Alternativo" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Ambiente" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "EDM" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Electronica" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Disco" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "New Age" ? "seleccionado" : ""
                            }`}
                    ...
                    <button
                        className={`genero-btn ${generoSeleccionado === "Punk" ? "seleccionado" : ""
                            }`}
